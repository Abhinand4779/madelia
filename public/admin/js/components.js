        ...
        const sidebarHTML = `
            ...
            <aside class="admin-sidebar">
                <div class="admin-sidebar-header">
                    <img src="../assets/Logo/madelia%20logo.png" alt="Madelia">
                </div>
                
                <nav class="admin-nav">
                    <a href="/admin/dashboard" class="admin-nav-link" title="Dashboards">
            ...
            <aside class="admin-secondary-sidebar" id="secondary-sidebar">
                ...
                <nav class="secondary-nav">
                    <a href="/admin/dashboard" class="secondary-nav-link">Dashboard</a>
                    ...
                    <a href="/admin/product/list" class="secondary-nav-link active">Product Lists</a>
                    <a href="/admin/product/create-or-update" class="secondary-nav-link">Create Product</a>
