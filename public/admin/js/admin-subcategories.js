...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mock Data Fallback
    let subCategories = [
        { id: 1, name: 'Women', image: '../assets/Logo/madelia%20logo.png', status: 'active', parentName: 'Fashion' },
        { id: 2, name: 'Men', image: '../assets/Logo/madelia%20logo.png', status: 'active', parentName: 'Fashion' }
    ];
        ...
        filtered.forEach((cat, index) => {
            ...
            tr.innerHTML = `
                ...
                <td style="padding: 1rem; border-bottom: 1px solid #e2e8f0; font-weight: 500;">
                    <img src="${cat.image || '../assets/Logo/madelia%20logo.png'}" alt="${cat.name}" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px; margin-right: 0.5rem; vertical-align: middle;">
    ...
    subCatForm.addEventListener('submit', async (e) => {
        e.preventDefault();
        const name = subCatForm.querySelector('#subCatName').value;
        const status = subCatForm.querySelector('#subCatStatus').value;
        ...
        let base64Image = '../assets/Logo/madelia%20logo.png';
