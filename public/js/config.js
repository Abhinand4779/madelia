...
const DEFAULT_CONFIG = {
    hero: {
        ...
        subtitle: 'Explore the exclusive fashion & jewelry collection from Madelia.',
    ...
    testimonials: [
        { id: 1, name: "Anjali Sharma", handle: "@anjali_styles", text: "The gold plating is so authentic! I wore the bangles to a wedding and everyone thought they were real gold. Amazing quality from Madelia.", rating: 5 },
        ...
        { id: 3, name: "Priya Iyer", handle: "@priya_jewels", text: "Finding traditional designs that don't feel heavy is hard. Madelia's signature earrings are my new favorites for daily wear.", rating: 5 }
    ],
    homeCategories: [
    ...
    footer: {
        storeName: 'Our Store',
        description: 'Madelia was started in 2022 to bring elegance and tradition to your everyday style.',
        newsletterText: 'Sign up for our newsletter and receive 10% off your',
        copyright: '©2026 Madelia. All Rights Reserved.',
