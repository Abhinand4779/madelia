                            ...
                            ${Auth.cart.map(item => `
                                <div class="cart-item">
                                    <div class="cart-item-img">
                                        <img src="${item.image_path || item.image || item.images?.[0] || 'assets/Logo/madelia%20logo.png'}" alt="${item.name}">
                                    </div>
                                    <div class="cart-item-details">
                                        ...
                                        <p class="item-meta">Category: ${item.category?.name || item.category || 'N/A'}</p>
