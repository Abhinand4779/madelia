    ...
    <div class="app-container">
        ...
        <main class="about-page" style="background-color: #0f2230; color: #fff; font-family: 'Montserrat', sans-serif;">
            <header style="height: 60vh; min-height: 400px; position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                ...
                <h1 style="position: relative; color: #d4af37; font-size: clamp(2.5rem, 5vw, 4rem); letter-spacing: 10px; text-transform: uppercase; font-weight: 300; z-index: 2; text-align: center;">Our Story</h1>
            </header>
            ...
            <section style="padding: 6rem 5%;">
                <div style="max-width: 1200px; margin: 0 auto; display: flex; flex-wrap: wrap; align-items: center; gap: 4rem;">
                    ...
                    <div style="flex: 1; min-width: 300px;">
                        <h2 style="color: #d4af37; font-size: 2.2rem; margin-bottom: 2rem; font-weight: 400; letter-spacing: 2px;">Hi, I'm Reshma, <br><span style="font-size: 1.5rem; color: #fff; font-weight: 300;">founder of Hue Story.</span></h2>
                        <p style="font-size: 1.1rem; line-height: 1.9; margin-bottom: 1.5rem; font-weight: 300; opacity: 0.9;">
                            My passion for fashion began at a young age and led me to pursue a Bachelor of Fashion Technology from St. Teresa's College, Ernakulam. Fashion has always been more than a profession to me—it is a form of creative expression and a lifelong dream.
                        </p>
                        <p style="font-size: 1.1rem; line-height: 1.9; font-weight: 300; opacity: 0.9;">
                            Although my career journey led me into accounting, my love for fashion, traditional wear, and styling never faded. Inspired by this dream and supported by my family, I founded Hue Story to create a space where women can discover fashion that feels personal, elegant, and uniquely their own.
                        </p>
                    </div>
                    ...
                    <div style="flex: 1; min-width: 300px; position: relative; text-align: center;">
                        ...
                        <img src="/assets/About/hero_navy.png" alt="Reshma - Founder" style="width: 100%; max-width: 450px; height: auto; position: relative; z-index: 1; object-fit: cover; box-shadow: 0 15px 40px rgba(0,0,0,0.5); border-radius: 10px;">
                    </div>
                    
                </div>
            </section>

            <section style="background-color: #0b1924; padding: 6rem 5%;">
                <div style="max-width: 1200px; margin: 0 auto; display: flex; flex-wrap: wrap-reverse; align-items: center; gap: 4rem;">
                    
                    <!-- Left: Image 2 -->
                    <div style="flex: 1; min-width: 300px; position: relative; text-align: center;">
                        <div style="position: absolute; top: -20px; right: 20px; width: 100%; height: 100%; border: 2px solid #d4af37; z-index: 0; border-radius: 10px; opacity: 0.5;"></div>
                        <img src="/assets/floral_banner.png" alt="Our Vision" style="width: 100%; max-width: 450px; height: auto; position: relative; z-index: 1; object-fit: cover; box-shadow: 0 15px 40px rgba(0,0,0,0.5); border-radius: 10px;">
                    </div>

                    <!-- Right: Text -->
                    <div style="flex: 1; min-width: 300px;">
                        <h2 style="color: #d4af37; font-size: 2.2rem; margin-bottom: 2rem; font-weight: 400; letter-spacing: 2px;">Our Vision</h2>
                        <p style="font-size: 1.1rem; line-height: 1.9; margin-bottom: 1.5rem; font-weight: 300; opacity: 0.9;">
                            My vision goes beyond selling clothing. I dream of bringing more customisation and personalisation to fashion, helping every woman express her individuality through pieces that truly reflect her story.
                        </p>
                        <p style="font-size: 1.1rem; line-height: 1.9; font-weight: 300; opacity: 0.9;">
                            From curated collections to saree pre-pleating, draping, and custom design services, every detail is chosen with love and purpose.
                        </p>
                    </div>
            ...
            <section style="padding: 6rem 5%; text-align: center; background: linear-gradient(to bottom, #0f2230, #0b1924);">
                <div style="max-width: 800px; margin: 0 auto;">
                    <i class="bi bi-quote" style="font-size: 4rem; color: #d4af37; opacity: 0.3; margin-bottom: 1rem; display: block;"></i>
                    <p style="font-size: 1.6rem; font-style: italic; font-weight: 300; line-height: 1.6; margin-bottom: 3rem; color: #fff;">
                        Because fashion isn't just about what you wear—it's about telling your story.
                    </p>
                    <div style="width: 60px; height: 2px; background-color: #d4af37; margin: 0 auto 2rem auto;"></div>
                    <h3 style="color: #d4af37; font-size: 1.3rem; font-weight: 400; letter-spacing: 2px; text-transform: uppercase;">
                        ✨ Hue Story — Your Story, Your Style, Your Hue
                    </h3>
                </div>
            </section>
        </main>
