...
<!-- font -->
<link href="/assets/css/xo2Q84RiLqR1.css?v=518" rel="stylesheet"/>
<link href="/assets/css/fxDjF2UjbT3M.css" rel="stylesheet"/>
<!-- css -->
<link href="/assets/css/rlqoxzRnhsHE.css?v=864" rel="stylesheet"/>
<link href="/assets/css/AOXgFhb8JAAw.css?v=873" rel="stylesheet"/>
<link href="/assets/css/DcIVa6uAXrCH.css?v=179" rel="stylesheet"/>
<link href="/assets/css/eiYo7M7TKBWA.css?v=411" rel="stylesheet"/>
<link href="/assets/css/JIHS5y7YJJPp.css?v=750" rel="stylesheet" type="text/css"/>
<link href="/assets/css/EuKg7NCuS760.css" rel="stylesheet"/>
<link href="/assets/css/bB2Z0EZ0ZAxu.css" rel="stylesheet"/>
<link href="/assets/css/ipAa5K8IuHu1.css" rel="stylesheet"/>
<link href="/assets/css/hSrv6UFVnZyK.css" rel="stylesheet"/>
<link href="/assets/css/iWWow45poi0O.css" rel="stylesheet"/>
<link href="/assets/css/2yATwjGLPLhk.css" rel="stylesheet"/>
<link href="/assets/css/mnZlW0ZESkpV.css" rel="stylesheet"/>
<link href="/assets/css/78KIva0e9rJw.css" rel="stylesheet"/>
<link href="/assets/css/SIC7hDzY1HLR.css" rel="stylesheet" type="text/css"/>
<style>
            .tf-select{
                width: 100%;
                border-radius: 12px;
...
<!-- /Top Bar -->
<!-- Header -->
<div wire:id="wd2eh6JYCQM4gdRuNtst" wire:initial-data='{"fingerprint":{"id":"wd2eh6JYCQM4gdRuNtst","name":"home.layout.header","locale":"en","path":"product\/emerald-kemp-pendant-necklace-ov4jO","method":"GET","v":"acj"},"effects":{"listeners":["cartRefresh"]},"serverMemo":{"children":[],"errors":[],"htmlHash":"fdb5c104","data":{"custom_domains":["saariniindia","papaymart"],"domain":"madeliadesigns"},"dataMeta":[],"checksum":"10a4aacf5bf8420b54aec1afca91241b03fb71c3f5c075db898a2ff1f24d4b4a"}}'>
...
<p><a class="__cf_email__" data-cfemail="6d000c090801040c09081e040a031e0c182d0a000c0401430e0200" href="/cdn-cgi/l/email-protection">[email protected]</a></p>
</li>
<li>
...
<!-- Livewire Component wire-end:wd2eh6JYCQM4gdRuNtst -->
<!-- /Header -->
<!-- Slider -->
<style>
...
<div wire:id="lS27bA8lrws74tnDaUvo" wire:initial-data='{"fingerprint":{"id":"lS27bA8lrws74tnDaUvo","name":"home.product","locale":"en","path":"product\/emerald-kemp-pendant-necklace-ov4jO","method":"GET","v":"acj"},"effects":{"listeners":[]},"serverMemo":{"children":[],"errors":[],"htmlHash":"d41ae67a","data":{"slug":"emerald-kemp-pendant-necklace-ov4jO","review":null,"rating":5,"quantity":1,"price":25,"size_id":1,"discount":0,"discount_price":25,"total_price":25,"actual_price":25,"avarage_kg":0,"product_quantity":1,"color_id":null,"is_avl_stiching":false,"stiching_price":0,"cart_attributes":[]},"dataMeta":[],"checksum":"3050beff70b6fe6430da8566f0b198e2d5af42fb4cead4707aaea297c66bcf4b"}}'>
<!-- breadcrumb -->
<div class="tf-breadcrumb">
<div class="container">
<div class="tf-breadcrumb-wrap">
<div class="tf-breadcrumb-list">
<a class="text text-caption-1" href="">Home</a>
<i class="icon icon-arrRight"></i>
<span class="text text-caption-1">{{ $product->name }}</span>
</div>
<div class="tf-breadcrumb-prev-next">
<a class="tf-breadcrumb-prev" href="javascript:;">
<i class="icon icon-arrLeft"></i>
</a>
<a class="tf-breadcrumb-back" href="javascript:;">
<i class="icon icon-squares-four"></i>
</a>
<a class="tf-breadcrumb-next" href="javascript:;">
<i class="icon icon-arrRight"></i>
</a>
</div>
</div>
...
<h3 class="name"> Emerald Kemp Pendant Necklace</h3>
<div class="sub">
...
<h5 class="price font-2">AU$ {{ $product->price }}</h5>
</div>
<p>
                                            Graceful and stylish, this Emerald Kemp Pendant Necklace features a stunning emerald-tone Kemp pendant paired with a sleek invisible chain. Its elegant traditional design makes it a perfect accessory for festive occasions, parties, and everyday charm.
                                        </p>
</div>
</div>
...
<span class="btn-quantity" wire:click="$set('quantity', 0)">-</span>
<input class="quantity-product" name="number" type="text" value="1" wire:model="quantity"/>
<span class="btn-quantity" wire:click="$set('quantity', 2)">+</span>
</div>
</div>
<div>
<div class="tf-product-info-by-btn mb_10">
<a class="btn-style-2 flex-grow-1 text-btn-uppercase fw-6 btn-add-to-cart" wire:click.prevent="addToCart"><span>
                                                   Add to Cart  -
                                                </span><span class="tf-qty-price total-price">
<i class="fa fa-spinner fa-spin" style="font-size:20px" wire:loading="" wire:target="addToCart"></i>
                                                      AU$ 25
                                                </span></a>
<a class="box-icon hover-tooltip text-caption-2 wishlist btn-icon-action" href="javascript:void(0);" wire:click.prevent="addToWishlist">
<span class="icon icon-heart"></span>
<span class="tooltip text-caption-2">Wishlist</span>
</a>
</div>
<a class="btn-style-3 text-btn-uppercase" href="javascript:void(0);" id="buy-it-now-btn" wire:click.prevent="buyNow">
<i class="fa fa-spinner fa-spin" style="font-size:20px" wire:loading="" wire:target="buyNow"></i>
                                                      
                                            Buy it now</a>
</div>
<div class="tf-product-info-help">
<div class="tf-product-info-extra-link">
<a class="tf-product-extra-icon" data-bs-toggle="modal" href="#delivery_return">
<div class="icon">
<i class="icon-shipping"></i>
</div>
<p class="text-caption-1">Delivery &amp; Return</p>
</a>
<a class="tf-product-extra-icon" href="https://api.whatsapp.com/send/?phone=&amp;text=Hi%2C+I+have+been+on+your+website+and+have+a+query.&amp;type=phone_number&amp;app_absent=0">
<div class="icon">
<i class="icon-question"></i>
</div>
<p class="text-caption-1">Ask A Question</p>
</a>
<a class="tf-product-extra-icon" data-bs-toggle="modal" href="#share_social">
<div class="icon">
...
<div class="image">
<img alt="" class="lazyload" data-src="/assets/images/s1bchakf55wCbcX80U86JDz8OGLtnI7M1y-1779953968.jpeg" src="{{ $product->image_path }}"/>
</div>
<div class="content">
<div class="text-title">
...
<span class="btn-quantity" wire:click="$set('quantity', 0)">-</span>
<input name="number" type="text" value="1" wire:model="quantity"/>
<span class="btn-quantity" wire:click="$set('quantity', 2)">+</span>
</div>
</div>
<div class="tf-sticky-atc-btns">
<a class="tf-btn w-100 btn-reset radius-4 btn-add-to-cart" wire:click.prevent="addToCart"><span class="text text-btn-uppercase">Add To Cart</span></a>
</div>
</div>
</form>
</div>
...
<section class="flat-spacing" x-data="{ reviewForm: false }">
<div class="container">
<div class="row">
<div class="col-12">
...
<div>
<div @click="reviewForm = false" class="btn-style-4 text-btn-uppercase letter-1 btn-comment-review" x-show="reviewForm">
                                                Cancel Review</div>
<div @click="reviewForm = true" class="btn-style-4 text-btn-uppercase letter-1 btn-comment-review btn-write-review" x-show="!reviewForm">
                                                Write a review</div>
</div>
</div>
...
<h4 class="">0 Comments</h4>
</div>
<div class="reply-comment-wrap">
</div>
</div>
<form class="form-write-review pt-5" x-show="reviewForm">
<div class="heading">
<h4>Write a review:</h4>
<div class="list-rating-check">
<input id="star5" name="rate" type="radio" value="5" wire:model="rating"/>
<label for="star5" title="text"></label>
<input id="star4" name="rate" type="radio" value="4" wire:model="rating"/>
<label for="star4" title="text"></label>
<input id="star3" name="rate" type="radio" value="3" wire:model="rating"/>
<label for="star3" title="text"></label>
<input id="star2" name="rate" type="radio" value="2" wire:model="rating"/>
<label for="star2" title="text"></label>
<input id="star1" name="rate" type="radio" value="1" wire:model="rating"/>
...
<textarea aria-required="true" class="" placeholder="Write your comment here" required="" rows="4" tabindex="2" wire:model="review"></textarea>
</fieldset>
</div>
<div class="button-submit">
<button class="text-btn-uppercase" type="submit" wire:click.prevent="submitReview">Submit Reviews</button>
</div>
</form>
</div>
</div>
...
</section> <!-- /Product_Description_Tabs -->
<!-- Ralated Products -->
<!-- /Ralated Products -->
...
<form accept-charset="utf-8" class="form-share" method="post" x-data="{ shareUrl: '/product/emerald-kemp-pendant-necklace-ov4jO' }">
<fieldset>
<input aria-required="true" tabindex="0" type="text" value="/product/emerald-kemp-pendant-necklace-ov4jO"/>
</fieldset>
<div @click="copyToClipboard(shareUrl)" class="button-submit">
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
         document.addEventListener('livewire:load', function () {
             Livewire.on('show-cart', function (event) {
                 $('#shoppingCart').modal('show');
             })
         })
    </script>
</div>
<!-- Livewire Component wire-end:lS27bA8lrws74tnDaUvo -->
<!-- /Iconbox -->
<!-- Footer -->
...
<i class="icon-mail"></i>
<p>
<a class="__cf_email__" data-cfemail="412c2025242d282025243228262f32203401262c20282d6f222e2c" href="/cdn-cgi/l/email-protection">[email protected]</a>
</p>
</li>
<li>
...
<!-- search -->
<div>
<div wire:id="kiKIWVJZMdg3p72upouk" wire:initial-data='{"fingerprint":{"id":"kiKIWVJZMdg3p72upouk","name":"common.dynamic-widget","locale":"en","path":"product\/emerald-kemp-pendant-necklace-ov4jO","method":"GET","v":"acj"},"effects":{"listeners":[]},"serverMemo":{"children":[],"errors":[],"htmlHash":"f2d65e9d","data":{"type":"home-search-1","dataId":null,"file":"search","search":null,"limit":2},"dataMeta":[],"checksum":"1c430181efeaae829bd9df7f970c0af1577a541d8273de2c91cb3282c00414ab"}}'>
...
<img alt="image-product" class="lazyload img-product" data-src="/assets/images/s1bchakf55wCbcX80U86JDz8OGLtnI7M1y-1779953968.jpeg" src="{{ $product->image_path }}"/>
<img alt="image-product" class="lazyload img-hover" data-src="/assets/images/s1bchakf55wCbcX80U86JDz8OGLtnI7M1y-1779953968.jpeg" src="{{ $product->image_path }}"/>
</a>
<div class="variant-wrap size-list">
<ul class="variant-box">
<li class="size-item">
...
<!-- Livewire Component wire-end:kiKIWVJZMdg3p72upouk --> </div>
<!-- /search -->
<div wire:id="M0s2Gy2PtmbaHWSIjjYn" wire:initial-data='{"fingerprint":{"id":"M0s2Gy2PtmbaHWSIjjYn","name":"home.carts","locale":"en","path":"product\/emerald-kemp-pendant-necklace-ov4jO","method":"GET","v":"acj"},"effects":{"listeners":["cartRefresh"]},"serverMemo":{"children":[],"errors":[],"htmlHash":"23e76271","data":[],"dataMeta":[],"checksum":"238b84457f920931c9646d28dae60ea591c6c288473f5d87eb8233e37c3e2169"}}'>
<!-- shoppingCart -->
...
<!-- Livewire Component wire-end:M0s2Gy2PtmbaHWSIjjYn -->
<!-- size-guide -->
<!-- /size-guide -->
...
<script>
            // Alpine.js function to copy the content to clipboard
            function copyToClipboard() {
                navigator.clipboard.writeText('/product/emerald-kemp-pendant-necklace-ov4jO');
                alert('Link copied to clipboard');
            }
        </script>
<script src="/assets/js/KB6ZaLpZaFl6.js" type="text/javascript"></script>
<script src="/assets/js/hfNxbEcZY5cN.js" type="text/javascript"></script>
<script src="/assets/js/g5Q4TaYiSHvi.js" type="text/javascript"></script>
<script src="/assets/js/2JQAyq1murt3.js" type="text/javascript"></script>
<script src="/assets/js/DauAH5sNdMYq.js" type="text/javascript"></script>
<script src="/assets/js/z2kGEst1Qf5P.js" type="text/javascript"></script>
<script src="/assets/js/kF2ZxYvDiIhV.js" type="text/javascript"></script>
<script src="/assets/js/bl2nnUlQEzHl.js" type="text/javascript"></script>
<script src="/assets/js/4uLscok3fUy4.js" type="text/javascript"></script>
<script src="/assets/js/pNZS9QPQjE3d.js" type="text/javascript"></script>
<script src="/assets/js/1p61OyT0MkJT.js" type="text/javascript"></script>
<script src="/assets/js/mSPtrc3rv8Kc.js" type="module"></script>
<script src="/assets/js/xcjckGFm3YmK.js" type="module"></script>
<script>
