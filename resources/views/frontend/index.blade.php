...
<!-- font -->
<link href="/assets/css/xo2Q84RiLqR1.css?v=506" rel="stylesheet"/>
<link href="/assets/css/fxDjF2UjbT3M.css" rel="stylesheet"/>
<!-- css -->
<link href="/assets/css/rlqoxzRnhsHE.css?v=354" rel="stylesheet"/>
<link href="/assets/css/AOXgFhb8JAAw.css?v=104" rel="stylesheet"/>
<link href="/assets/css/DcIVa6uAXrCH.css?v=191" rel="stylesheet"/>
<link href="/assets/css/eiYo7M7TKBWA.css?v=482" rel="stylesheet"/>
<link href="/assets/css/JIHS5y7YJJPp.css?v=862" rel="stylesheet" type="text/css"/>
<style>
...
<li class="menu-item"><a class="item-link" href="index.html">HOME</a></li>
<li class="menu-item position-relative">
<a class="item-link" href="/shop">
...
<div class="sub-top">
<a class="tf-btn btn-white btn-reset has-border" href="#">Guest Login</a>
<a class="tf-btn btn-reset" href="login.html">Login</a>
<p class="text-center text-secondary-2">Don’t have an account? <a href="register.html">Register</a></p>
</div>
</div>
</li>
<li class="nav-wishlist"><a class="nav-icon-item" href="wishlist.html">
<svg class="icon" fill="none" height="24" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<a class="mb-menu-link" href="index.html">Home</a>
</li>
...
<p><a class="__cf_email__" data-cfemail="600d0104050c090104051309070e13011520070d01090c4e030f0d" href="/cdn-cgi/l/email-protection">[email protected]</a></p>
</li>
<li>
...
<div class="swiper tf-sw-slideshow" data-auto-play="true" data-centered="false" data-effect="fade" data-loop="true" data-mobile="1" data-preview="1" data-space="0" data-space-mb="0" data-tablet="1" dir="ltr">
...
<a class="tf-btn btn-fill btn-white" href=""><span class="text">Explore Collection</span><i class="icon icon-arrowUpRight"></i></a>
</div>
</div>
</div>
</div>
...
<a class="active" data-bs-toggle="tab" href="#newArrivals">New Arrivals</a>
</li>
<li class="nav-tab-item" role="presentation">
<a data-bs-toggle="tab" href="#bestSeller">Best Seller</a>
</li>
</ul>
...
<div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.2s">
    <div class="card-product-wrapper">
        <a href="{{ route('product', ['id' => $product->id]) }}" class="product-img">
            <img class="lazyload img-product" data-src="{{ $product->image_path }}" src="{{ $product->image_path }}" alt="{{ $product->name }}">
            <img class="lazyload img-hover" data-src="{{ $product->image_path }}" src="{{ $product->image_path }}" alt="{{ $product->name }}">
        </a>
        <div class="variant-wrap size-list">
            ...
            @endphp
            @if(!empty($variants))
                <li class="size-item">{{ $variants[0] }}</li>
            @endif
            </ul>
        </div>
        ...
        <div class="list-btn-main">
            <a href="{{ route('product', ['id' => $product->id]) }}" class="btn-main-product">
                View Details
            </a>
        </div>
    </div>
    <div class="card-product-info">
        <a href="{{ route('product', ['id' => $product->id]) }}" class="title link">
            {{ $product->name }}
        </a>
        <span class="price">AU$ {{ $product->price }}</span>
    </div>
</div>
@endforeach
</div>
<div class="text-center sec-btn">
<a class="btn-line" href="#">View All Products</a>
</div>
</div>
...
<div class="container">
<div class="swiper tf-sw-iconbox" data-mobile="1" data-mobile-sm="2" data-pagination="1" data-pagination-lg="4" data-pagination-md="3" data-pagination-sm="2" data-preview="4" data-space="15" data-space-lg="30" data-space-md="30" data-tablet="3" dir="ltr">
<div class="swiper-wrapper">
<div class="swiper-slide">
...
<i class="icon-mail"></i>
<p>
<a class="__cf_email__" data-cfemail="0865696c6d6461696c6d7b616f667b697d486f65696164266b6765" href="/cdn-cgi/l/email-protection">[email protected]</a>
</p>
</li>
<li>
...
<a class="footer-menu_item" href="/shop">Necklace Sets and Chokers</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="/shop">Mangalsutra</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="/shop">Harams</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="/shop">Invisible Chains and Pendants</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="/shop">Hair Accessories</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="/shop">Saree</a>
</li>
</ul>
</div>
</div>
...
<ul class="footer-menu-list">
<li class="text-caption-1">
<a class="footer-menu_item" href="#"> Return Policy</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="#"> Shipping Policy</a>
</li>
<li class="text-caption-1">
<a class="footer-menu_item" href="#"> Privacy Policy</a>
</li>
</ul>
</div>
</div>
