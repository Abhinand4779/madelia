...
<i class="text-xl fa fa-server"></i>    
                    ...
                    <a href="/admin/coupon-codes" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Coupon Codes'">
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="Ceuk2Sa6KU29VZFCxban">
                ...
                <div class="px-4 py-4 sm:px-5">
                    ...
                    <form wire:submit.prevent="updateOrCreate">
                        <div class="mt-4 space-y-4">
                            ...
                            <label class="block">
                                <span>Code:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="code" placeholder="Enter Title" type="text">
                            ...
                            <label class="block">
                                ...
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="description" placeholder="Enter Title" type="text">
                            ...
                            <label class="block">
                                <span>Discount (%):</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="discount" placeholder="Enter Title" type="number">
                            ...
                            <label class="block">
                                <span>Min:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="min" placeholder="Enter Min" type="number">
                            ...
                            <label class="block">
                                <span>Max:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="max" placeholder="Enter max" type="number">
...
<!-- Livewire Component wire-end:Ceuk2Sa6KU29VZFCxban -->
          </main>
        </div>
        <!-- 
