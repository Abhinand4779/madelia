...
<i class="text-xl fas fa-award"></i>    
                    ...
                    <a href="/admin/shipping-charges" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Shipping Charge'">
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="AlIeaKF77liv96GFc5i3">
                ...
                <div class="is-scrollbar-hidden min-w-full overflow-x-auto">
                    <table class="is-hoverable w-full text-left">
                        ...
                        <tbody>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('24', 'is_home_area')">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('24', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('24')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('24')">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('23', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('23', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('23')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('23')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('1', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('1', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="delete('1')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('2', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('2', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('2')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('2')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('3', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('3', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('3')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('3')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('4', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('4', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('4')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('4')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('5', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('5', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('5')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('5')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('6', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('6', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('6')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('6')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('7', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('7', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('7')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('7')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('8', 'is_home_area')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>

                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div wire:click="changeStatus('8', 'is_country')">
                                        <input class="form-switch is-outline h-5 w-10 rounded-full border border-slate-400/70 bg-slate-100 before:rounded-full before:bg-slate-300 checked:border-primary checked:before:bg-primary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-navy-400 dark:checked:border-accent dark:checked:before:bg-accent" type="checkbox">                                        </div>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                      <div class="flex gap-4">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit('8')">
                                          <i class="fas fa-pencil"></i>
                                        </a>
                                        
                                        <a href="javascript:void(0);" wire:click="delete('8')">
                                          <i class="fas fa-trash"></i>
                                        </a>
                    ...
                    <form wire:submit.prevent="updateOrCreate">
                        <div class="mt-4 space-y-4">
                            ...
                            <label class="block mt-4">
                                <span>Amount:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="amount" placeholder="Enter amount" type="number">
                            ...
                            <label class="block mt-4">
                                ...
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="extra_charges" placeholder="Enter extra_charges" type="number">
...
<!-- Livewire Component wire-end:AlIeaKF77liv96GFc5i3 -->
          </main>
        </div>
        <!-- 
