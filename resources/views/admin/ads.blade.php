<!DOCTYPE html><html lang="en" class="" style="--vh: 7.2px;"><head>
        ...
        <meta name="csrf-token" content="HQInZhJJZRNPpnqgyylDJzYWPZmUNxw6Xf7bbE8c">
...
<i class="text-xl fas fa-images"></i>    
                ...
                <div class="flex flex-col pt-2 pb-5">
                  ...
                  <div class="px-4 mt-3">
                    <form method="POST" action="/logout">
                        <input type="hidden" name="_token" value="HQInZhJJZRNPpnqgyylDJzYWPZmUNxw6Xf7bbE8c" autocomplete="off">                        <button type="submit" class="w-full space-x-2 text-white btn h-9 bg-primary hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="ZcG8U4Q4cXNyrwjut06m">
                        ...
                        <tbody>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        ...
                                        <div class="avatar size-9">
                                                                                                                                        <img class="mask is-squircle" src="/images/products/IfkYYDdKgokGz1eGRNUKPk68xoHsNWFlws-1778527672.jpg" alt="avatar">
                                                                                      </div>
                                    </td>
                ...
                <div class="px-4 py-4 sm:px-5">
                    ...
                    <form wire:submit.prevent="updateOrCreate">
                        <div class="mt-4 space-y-4">
                            ...
                            <label class="block">
                                <span class="font-medium text-slate-600 dark:text-navy-100">Select Brand</span>
                                <select class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="brand_id">
    <option value="">Choose...</option>
        <option value="1">madeliadesigns</option>
    </select>
                            ...
                            <label class="block">
                                <span>Link:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="link" placeholder="Enter Link" type="text">
    ...
    <div class="filepond--root filepond--hopper" data-style-button-remove-item-position="left" data-style-button-process-item-position="right" data-style-load-indicator-position="right" data-style-progress-indicator-position="right" data-style-button-remove-item-align="false"><input class="filepond--browser" type="file" id="filepond--browser-lpcssyvjp" name="filepond" aria-controls="filepond--assistant-lpcssyvjp" aria-labelledby="filepond--drop-label-lpcssyvjp"><div style="height: 100%;"></div><a class="filepond--credits" aria-hidden="true" href="https://pqina.nl/" target="_blank" rel="noopener noreferrer">Powered by PQINA</a><div class="filepond--drop-label" style="transform: translate3d(0px, 0px, 0px); opacity: 1;"><label for="filepond--browser-lpcssyvjp" id="filepond--drop-label-lpcssyvjp" aria-hidden="true">Drag &amp; Drop your files or <span class="filepond--label-action" tabindex="0">Browse</span></label></div><div class="filepond--list-scroller"><ul class="filepond--list" role="list"></ul></div><div class="filepond--panel filepond--panel-root" data-scalable="true"><div class="filepond--panel-top filepond--panel-root"></div><div class="filepond--panel-center filepond--panel-root"></div><div class="filepond--panel-bottom filepond--panel-root"></div></div><div class="filepond--drip"></div><span class="filepond--assistant" id="filepond--assistant-lpcssyvjp" role="status" aria-live="polite" aria-relevant="additions"></span><fieldset class="filepond--data"></fieldset></div>
</div>
...
<!-- Livewire Component wire-end:ZcG8U4Q4cXNyrwjut06m -->
          </main>
        </div>
        <!-- 
        ...
        <script>
          ...
          function updateOnlineEvent()
          {
            $.ajax({
              ...
              type: "GET",
              data: {
                _token: "HQInZhJJZRNPpnqgyylDJzYWPZmUNxw6Xf7bbE8c",
              },
