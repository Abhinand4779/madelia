<!DOCTYPE html><html lang="en" class="" style="--vh: 7.2px;"><head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="csrf-token" content="TSe1lJmC9seuU0mkHusOHMTSKKy1Y1Sc79xEqlJS">

        <title>madeliadesigns</title>
        <meta name="keywords" content="">
        <meta name="description" content="">
        <meta name="author" content="madeliadesigns">
        <link rel="shortcut icon" href="/images/brands/fo3dLCSUuNSadjsAJAGGdptbGXZIa7Jb5S-1778432057.png">
        <!-- Fonts -->
        ...
        <!-- Scripts -->
        <script src="/js/k73rosFuRWOa.js" defer=""></script>
        <link rel="stylesheet" href="/css/k6XrbtP4vCfG.css">
        <link rel="stylesheet" href="/css/app.css?v=1.2.1">
    ...
    <img class="mx-auto h-11 w-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]" src="/images/brands/I9uMBss51oRgkCJSSWlcQGTPz9r4vqvquN-1778432057.png" alt="logo">
</a>
        </div>
        ...
        <div class="flex flex-col pt-6 space-y-4 overflow-y-auto is-scrollbar-hidden grow">
          <!-- Dashobards -->
                    ...
                    <a href="/admin/dashboard" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Dashboard'">
<i class="text-xl fas fa-tachometer-alt"></i>    
</a>
                    <a href="/admin/ads" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Banners'">
...
<i class="text-xl fas fa-layer-group"></i>    
                    ...
                    <a href="/admin/hsn-codes" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'HSN Codes'">
<i class="text-xl fas fa-file-invoice"></i>    
</a>
                    <a href="/admin/order/list" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Order'">
<i class="text-xl fas fa-shopping-cart"></i>    
</a>
                    <a href="/admin/pages" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Pages'">
...
<i class="text-xl fas fa-truck"></i>    
                    ...
                    <a href="/admin/brands/1/groups" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Main titles / Videos'">
<i class="text-xl fa fa-list-alt"></i>    
</a>
          <a href="/admin/ads/dynamic" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Dynamic Products'">
<i class="text-xl fas fa-images"></i>
</a>
        ...
        <div class="flex flex-col items-center py-3 space-y-3">
          <!-- Settings -->
          <a href="/user/settings" class="flex items-center justify-center transition-colors duration-200 rounded-lg outline-none h-11 w-11 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
          ...
          <div x-data="usePopper({placement:'right-end',offset:12})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="flex">
            <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="w-12 h-12 avatar">
              <img class="rounded-full" src="https://ui-avatars.com/api/?name=T+U&amp;color=7F9CF5&amp;background=EBF4FF" alt="Test User">
            ...
            <div :class="isShowPopper &amp;&amp; 'show'" class="fixed popper-root" x-ref="popperRoot" style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(76px, -12px);" data-popper-placement="right-end">
              <div class="w-64 bg-white border rounded-lg popper-box border-slate-150 shadow-soft dark:border-navy-600 dark:bg-navy-700">
                ...
                <div class="flex flex-col pt-2 pb-5">
                  <a href="/user/settings" class="flex items-center px-4 py-2 space-x-3 tracking-wide transition-all outline-none group hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                  ...
                  <div class="px-4 mt-3">
                    <form method="POST" action="/logout">
                        <input type="hidden" name="_token" value="TSe1lJmC9seuU0mkHusOHMTSKKy1Y1Sc79xEqlJS" autocomplete="off">                        <button type="submit" class="w-full space-x-2 text-white btn h-9 bg-primary hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
    ...
    <div class="sidebar-panel">
      <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
        ...
        </div></div></div></div><div class="simplebar-placeholder" style="width: 126px; height: 135px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div>
      </div>
    </div>
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="Q1PxBj4YARHhTkdUQiLn">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex">
                    <div class="flex items-center" x-data="{ isInputActive: false }">
                        <label class="block">
                            <input wire:model="search" class="form-input bg-transparent px-1 text-right transition-all duration-100 placeholder:text-slate-500 dark:placeholder:text-navy-200 w-32 lg:w-48" placeholder="Search here..." type="text">
                        </label> 
                    ...
                    <button @click="showModal = true" id="updateOrCreate" wire:click="resetForm" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card mt-3">
                ...
                <div class="flex flex-col justify-between space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5">
                    <div class="flex items-center space-x-2 text-xs+">
                        <span>Show</span>
                        <label class="block">
                            <select wire:model="limit" class="form-select rounded-full border border-slate-300 bg-white px-2 py-1 pr-6 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                <option>10</option>
                                <option>30</option>
                                <option>50</option>
                                <option>150</option>
    ...
    <div x-data="{ showModal: false }" class="inline-flex">
        <button @click="showModal = true" id="openModal" class="hidden  btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            
        </button>

        
        <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5" x-show="showModal" role="dialog" @keydown.window.escape="showModal = false" style="display: none;">
            ...
            <div class="overflow-auto relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700" x-show="showModal" x-transition:enter="easy-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="easy-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" style="display: none;">
                <div class="flex justify-between rounded-t-lg bg-slate-200 px-4 py-3 dark:bg-navy-800 sm:px-5">
                    <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                        Add / Update  Dynamic Ads
                    </h3>
                ...
                <div class="px-4 py-4 sm:px-5">
                    ...
                    <form wire:submit.prevent="updateOrCreate">
                        <div class="mt-4 space-y-4">
                            ...
                            <label class="block">
                                <span>Name:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="title" placeholder="Enter Title" type="text">
                            ...
                            <label class="block">
                                ...
                                <textarea class="form-textarea mt-1.5 w-full resize-none rounded-lg border border-slate-300 bg-transparent p-2.5 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="description" placeholder="Enter Description"></textarea>

                            </label>
                            
                            <label class="block">
                                <span>Background Image:</span>
                                <div class="mt-2 filepond fp-bordered" wire:ignore="">
    <div class="filepond--root filepond--hopper" data-style-button-remove-item-position="left" data-style-button-process-item-position="right" data-style-load-indicator-position="right" data-style-progress-indicator-position="right" data-style-button-remove-item-align="false"><input class="filepond--browser" type="file" id="filepond--browser-p4vzaqiil" name="filepond" aria-controls="filepond--assistant-p4vzaqiil" aria-labelledby="filepond--drop-label-p4vzaqiil"><div style="height: 100%;"></div><a class="filepond--credits" aria-hidden="true" href="https://pqina.nl/" target="_blank" rel="noopener noreferrer">Powered by PQINA</a><div class="filepond--drop-label" style="transform: translate3d(0px, 0px, 0px); opacity: 1;"><label for="filepond--browser-p4vzaqiil" id="filepond--drop-label-p4vzaqiil" aria-hidden="true">Drag &amp; Drop your files or <span class="filepond--label-action" tabindex="0">Browse</span></label></div><div class="filepond--list-scroller"><ul class="filepond--list" role="list"></ul></div><div class="filepond--panel filepond--panel-root" data-scalable="true"><div class="filepond--panel-top filepond--panel-root"></div><div class="filepond--panel-center filepond--panel-root"></div><div class="filepond--panel-bottom filepond--panel-root"></div></div><div class="filepond--drip"></div><span class="filepond--assistant" id="filepond--assistant-p4vzaqiil" role="status" aria-live="polite" aria-relevant="additions"></span><fieldset class="filepond--data"></fieldset></div>
</div>
                            ...
                            <label class="block">
                                <span class="font-medium text-slate-600 dark:text-navy-100">Select Products</span>
                                <div wire:ignore="">
    <select id="multiple" x-init="() =&gt; {
        $el._tom = new Tom($el, {
            onChange: value =&gt; {
                window.livewire.find('Q1PxBj4YARHhTkdUQiLn').set('product_ids', value);
            },
            
        });
        
        this.addEventListener('select-edit', e =&gt; {
            $el._tom.setValue(e.detail);
        });
        
        this.addEventListener('select-clear', e =&gt; {
            $el._tom.setValue([]);
        });
    ...
    }" class="mt-1.5 w-full tomselected ts-hidden-accessible" multiple="multiple" placeholder="Select..." autocomplete="off" tabindex="-1">
        <option value="">Select...</option>
                    <option value="4">Ruby Stone Pendant Necklace Set</option>
                    <option value="5">Emerald Kemp Pendant Necklace</option>
                    <option value="6">Ruby Drop Pendant Necklace Set</option>
                    <option value="7">Stone Pendant Necklace Set</option>
                    <option value="8">Meenakari Necklace Set</option>
                    <option value="9">Pearl Drop Kemp Necklace Set</option>
                    <option value="10">Temple Style Short Haram</option>
                    <option value="11">Lakshmi Kasu Mala</option>
                    <option value="12">Traditional Temple Necklace Set</option>
                    <option value="13">Temple Lakshmi Jewellery</option>
                    <option value="14">Peacock Attigai</option>
                    <option value="15">American Diamond Zircon Necklace Set with Colored Stones</option>
                    <option value="16">American Diamond Zircon Necklace Set with Colored Stones</option>
                    <option value="17">Antique Kemp Guttapusalu-Inspired Temple Jewellery Set</option>
                    <option value="18">Antique Laxmi Temple Jewellery Set</option>
                    <option value="19">Palakka Mala</option>
                    <option value="20">Palakka Mala </option>
                    <option value="21">Kempu Necklace Set</option>
                    <option value="22">Palakka Mala</option>
                    <option value="23">Palakka Mala</option>
                    <option value="24">Palakka Mala</option>
                    <option value="25">Kempu Addigai</option>
                    <option value="26">Pearl Necklace</option>
                    <option value="27">Kemp Stone Necklace Set</option>
                    <option value="28">Lakshmi Temple Necklace</option>
                    <option value="29">Coin Necklace</option>
                    <option value="30">Lakshmi Necklace Set</option>
                    <option value="31">Antique Green Stone Necklace Set</option>
                    <option value="32">Pearl Necklace Set Price</option>
                    <option value="33">Antique Gold Kemp Chandbali Mani Mala Set</option>
                    <option value="34">Antique Kemp Guttapusalu Long Haram Set</option>
                    <option value="35">Temple Jewellery Necklace Set</option>
                    <option value="36">South Indian Temple Jewellery</option>
                    <option value="37">Kasumala</option>
                    <option value="38">Kasumala</option>
                    <option value="39">Kasumala</option>
                    <option value="40">Lakshmi Haram</option>
                    <option value="41">Mangalsutra</option>
                    <option value="42">Mangalsutra</option>
                    <option value="43">Mangalsutra</option>
                    <option value="44">Mangalsutra</option>
                    <option value="45">Mangalsutra</option>
                    <option value="46">Mangalsutra</option>
                    <option value="47">Lotus Haram</option>
                    <option value="48">Green Stone Long Haram</option>
                    <option value="49">Kemp Stone Temple Long Haram</option>
                    <option value="50">Lakshmi Haram</option>
                    <option value="51">Yamini Lakshmi Haram</option>
                    <option value="52">Invisible Chain Pendant</option>
                    <option value="53">Invisible Chain Pendant</option>
                    <option value="54">Lotus Necklace Set</option>
                    <option value="55">Multicolor Heart Station</option>
                    <option value="56">Lotus Necklace Set</option>
                    <option value="57">Lotus Necklace Set</option>
                    <option value="58">Clover Station Necklace</option>
                    <option value="59">Clover Station Necklace</option>
                    <option value="60">Emerald Thali Pendant</option>
                    <option value="61">Invisible Chain Pendant</option>
                    <option value="62">Emerald  Stone Pendant Set</option>
                    <option value="63">Blooming Charm Necklace</option>
                    <option value="64">Station Necklace</option>
                    <option value="65">Lotus Necklace Set</option>
                    <option value="66">Lotus Necklace Set</option>
                    <option value="67">Lotus Necklace Set</option>
                    <option value="68">Floral Kemp Stone Necklace Set</option>
                    <option value="69">Meenakari Lotus Jewellery</option>
                    <option value="70">Jasmine Strings - 1 Layer</option>
                    <option value="71">Jasmine Strings - 2 Layer</option>
                    <option value="72">Kanakambaram Strings</option>
                    <option value="73">Radha Krishna Mural Kasavu Saree</option>
                    <option value="74">Kathakali Kasavu Saree</option>
                    <option value="75">Mural Art Onam Kasavu Saree</option>
                    <option value="76">Radha Krishna Kasavu Saree</option>
            </select><div class="ts-wrapper mt-1.5 w-full multi"><div class="ts-control"><input type="select-multiple" autocomplete="off" size="1" tabindex="0" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="multiple-ts-dropdown" id="multiple-ts-control" placeholder="Select..."></div><div class="ts-dropdown multi" style="display: none;"><div role="listbox" tabindex="-1" class="ts-dropdown-content" id="multiple-ts-dropdown"></div></div></div>
</div>
                            ...
                            <div class="space-x-2 text-right">
                                <a @click="showModal = false" id="closeModal" class="btn min-w-[7rem] rounded-full border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                                    Cancel
                                </a>
                                <button type="submit" class="btn min-w-[7rem] rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                    <div wire:loading="" wire:target="updateOrCreate" class="mr-1 spinner h-4 w-4 animate-spin rounded-full border-[3px] border-white-500 border-r-transparent dark:border-white-500 dark:border-r-transparent">
                                    </div> Apply
                                </button>
                            </div>
                        </div>
...
<!-- Livewire Component wire-end:Q1PxBj4YARHhTkdUQiLn -->
          </main>
        </div>
        <!-- 
    ...
    function callBack()
    {
        ...
        <script>
          ...
          {
            $.ajax({
              url: "/event/client_web_events",
              type: "GET",
              data: {
                _token: "TSe1lJmC9seuU0mkHusOHMTSKKy1Y1Sc79xEqlJS",
              },
