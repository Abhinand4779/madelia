...
<i class="text-xl fas fa-star"></i>    
                    ...
                    <a href="/admin/home-brands" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Home Brands'">
...
<i class="text-xl fas fa-images"></i>    
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="qSGb2N547jnTCcw0jpRJ">

    <div class="grid grid-cols-1 gap-4 mt-4 sm:gap-5 lg:gap-6">
        ...
        <div>
            <div class="flex items-center justify-between">
                ...
                <div class="flex">
                    ...
                    <button @click="showModal = true" id="updateOrCreate" wire:click="resetForm" class="w-8 h-8 p-0 rounded-full btn hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <table class="w-full text-left is-hoverable">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-3 font-semibold uppercase rounded-tr-lg whitespace-nowrap bg-slate-200 text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                                    Action
                                </th>
                            </tr>
                        </thead>
    ...
    <div x-data="{ showModal: false }" class="inline-flex">
        <button @click="showModal = true" id="openModal" class="hidden w-8 h-8 p-0 rounded-full btn hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
    ...
    <div class="filepond--root filepond--hopper" id="6a41fde5c4046" data-style-button-remove-item-position="left" data-style-button-process-item-position="right" data-style-load-indicator-position="right" data-style-progress-indicator-position="right" data-style-button-remove-item-align="false"><input class="filepond--browser" type="file" id="filepond--browser-hoka9acq1" name="filepond" aria-controls="filepond--assistant-hoka9acq1" aria-labelledby="filepond--drop-label-hoka9acq1"><div style="height: 100%;"></div><a class="filepond--credits" aria-hidden="true" href="https://pqina.nl/" target="_blank" rel="noopener noreferrer">Powered by PQINA</a><div class="filepond--drop-label" style="transform: translate3d(0px, 0px, 0px); opacity: 1;"><label for="filepond--browser-hoka9acq1" id="filepond--drop-label-hoka9acq1" aria-hidden="true">Drag &amp; Drop your files or <span class="filepond--label-action" tabindex="0">Browse</span></label></div><div class="filepond--list-scroller"><ul class="filepond--list" role="list"></ul></div><div class="filepond--panel filepond--panel-root" data-scalable="true"><div class="filepond--panel-top filepond--panel-root"></div><div class="filepond--panel-center filepond--panel-root"></div><div class="filepond--panel-bottom filepond--panel-root"></div></div><div class="filepond--drip"></div><span class="filepond--assistant" id="filepond--assistant-hoka9acq1" role="status" aria-live="polite" aria-relevant="additions"></span><fieldset class="filepond--data"></fieldset></div>
</div>
                            ...
                            <label class="block">
                                <span>Url:</span>
                                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" wire:model="url" placeholder="Enter url" type="text">
...
<!-- Livewire Component wire-end:qSGb2N547jnTCcw0jpRJ -->
          </main>
        </div>
        <!-- 
