    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
      ...
      <div class="ads-header-row">
        ...
        <div class="ads-actions">
          ...
          <button class="btn-plus" onclick="document.getElementById('subCatModalOverlay').style.display='flex'"><i
      ...
      <div class="ads-table-card">
        <table class="custom-table" style="width: 100%;">
          ...
          <tbody id="Sub Categories-table-body">
            <tr>
              <td>1</td>
              <td>Women</td>
              <td><img src="/assets/Logo/madelia%20logo.png" alt="Cat" class="cat-thumbnail"></td>
              <td><span class="badge-status bg-success-light">Active</span></td>
              <td>
      ...
      <!-- Sub Category Modal -->
      <div id="subCatModalOverlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
        <div style="background: #fff; width: 450px; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
          <div style="padding: 1.5rem 2rem; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin: 0; font-size: 1.2rem; color: #ffffff;">Add Sub Category</h3>
            <button onclick="document.getElementById('subCatModalOverlay').style.display='none'" style="background: transparent; border: none; font-size: 1.2rem; color: #94a3b8; cursor: pointer;"><i class="fa fa-times"></i></button>
          </div>
          <form id="subCatForm" style="padding: 2rem;">
            <div style="margin-bottom: 1.5rem;">
              <label class="form-label">Sub Category Name</label>
              <input type="text" class="form-control" id="subCatName" required placeholder="E.g. Tops">
            </div>
            <div style="margin-bottom: 1.5rem;">
              <label class="form-label">Parent Category</label>
              <select class="form-select" id="parentCatSelect" required>
                <!-- Populated via JS -->
              </select>
            </div>
            <div style="margin-bottom: 1.5rem;">
              <label class="form-label">Sub Category Image</label>
              <input type="file" class="form-control" id="subCatImage" accept="image/*" required>
            </div>
            <div style="margin-bottom: 1.5rem;">
              <label class="form-label">Status</label>
              <select class="form-select" id="subCatStatus" required>
                <option value="active">Active</option>
                <option value="inactive">Inactive</option>
              </select>
            </div>
            <div class="modal-footer-custom">
              <button type="button" class="btn-cancel" onclick="document.getElementById('subCatModalOverlay').style.display='none'">Cancel</button>
      ...
      <script src="/admin/js/admin-subcategories.js"></script>
    </main>
  </div>
  <!-- 
