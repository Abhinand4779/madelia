<html lang="en" class="" style="--vh: 7.2px;">
...
<head>
  ...
  <script>window.Livewire = { start: function () { }, emit: function () { }, find: function () { return { entangle: function () { return {}; } }; } }; window.livewire = window.Livewire;</script>
</head>
...
<body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
  ...
  <div id="root" class="flex min-h-100vh grow bg-slate-50 dark:bg-navy-900">
        ...
        <div
          ...
          <div class="flex pt-4">
            <a href="/admin/dashboard">
              <img class="mx-auto h-11 w-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
                src="/assets/Logo/madelia%20logo.png" alt="logo">
            </a>
          </div>
          ...
          <div class="flex flex-col pt-6 space-y-4 overflow-y-auto is-scrollbar-hidden grow">
            ...
            <a href="/admin/categories"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 font-medium text-primary dark:text-accent-light"
              x-tooltip.placement.right="'Categories'">
              <i class="text-xl fa fa-list"></i>
            </a>
            <a href="/admin/orders"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Order'">
              <i class="text-xl fas fa-shopping-cart"></i>
            </a>
            <a href="pages.html"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Pages'">
              <i class="text-xl fas fa-file-alt"></i>
            </a>
            <a href="/admin/brands"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Brand'">
              <i class="text-xl fa fa-server"></i>
            </a>
            <a href="/admin/coupon-codes"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Coupon Codes'">
              <i class="text-xl fas fa-tags"></i>
            </a>
            <a href="/admin/reviews"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Reviews'">
              <i class="text-xl fas fa-star"></i>
            </a>
            <a href="/admin/home-brands"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Home Brands'">
              <i class="text-xl fas fa-award"></i>
            </a>
            <a href="/admin/shipping-charges"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Shipping Charge'">
              <i class="text-xl fas fa-truck"></i>
            </a>

            <a href="brands.html/1/groups"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Main titles / Videos'">
              <i class="text-xl fa fa-list-alt"></i>
            </a>
            <a href="ads.html/dynamic"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              x-tooltip.placement.right="'Dynamic Products'">
              <i class="text-xl fas fa-images"></i>
            </a>
            ...
            <div x-data="usePopper({placement:'right-end',offset:12})"
              ...
              <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="w-12 h-12 avatar">
                <img class="rounded-full"
                  src="https://ui-avatars.com/api/?name=A&amp;color=7F9CF5&amp;background=EBF4FF" alt="Madelia">
                <span
              ...
              <div :class="isShowPopper &amp;&amp; 'show'" class="fixed popper-root" x-ref="popperRoot"
                ...
                <div
                  ...
                  <div class="flex flex-col pt-2 pb-5">
                    ...
                    <div class="px-4 mt-3">
                      <button type="button" onclick="Auth.logout(); window.location.href='/admin/login'"
      ...
      <div class="sidebar-panel">
        <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
          ...
          <div x-data="{expandedItem:null}" class="h-[calc(100%-4.5rem)] overflow-x-hidden pb-6"
            x-init="$el._x_simplebar = new SimpleBar($el);" data-simplebar="init">
            <div class="simplebar-wrapper" style="margin: 0px 0px -24px;">
                  ...
                  <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content"
                    ...
                    <div class="simplebar-content" style="padding: 0px 0px 24px;">
                      <ul class="flex flex-col flex-1 px-4 font-inter">
                        ...
                        <li>
                          <a href="/admin/product/create-or-update"
                            class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                            Create Product
                          </a>
                        </li>
              ...
              <div class="simplebar-placeholder" style="width: 126px; height: 83px;"></div>
            </div>
        ...
        <div class="flex w-full items-center justify-between">
          ...
          <div class="-mr-1.5 flex items-center space-x-2">
            ...
            <div class="flex" x-data="usePopper({placement:'bottom-end',offset:12})"
              ...
              <div :class="isShowPopper &amp;&amp; 'show'" class="popper-root" x-ref="popperRoot"
                style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-194px, 58px);"
            ...
            <button @click="$store.global.isDarkModeEnabled = !$store.global.isDarkModeEnabled"
              ...
              <svg x-show="$store.global.isDarkModeEnabled"
                ...
                class="h-6 w-6 text-amber-400" fill="currentColor" viewBox="0 0 24 24" style="display: none;">
                <path
            ...
            <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false"
              ...
              <div :class="isShowPopper &amp;&amp; 'show'" class="popper-root" x-ref="popperRoot"
                style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-58px, 58px);"
                data-popper-placement="bottom-end">
                <div x-data="{activeTab:'tabAll'}"
                  ...
                  <div class="tab-content flex flex-col overflow-hidden">
                    ...
                    <div x-show="activeTab === 'tabAlerts'" x-transition:enter="transition-all duration-300 easy-in-out"
                      x-transition:enter-start="opacity-0 [transform:translate3d(1rem,0,0)]"
                      x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                      class="is-scrollbar-hidden space-y-4 overflow-y-auto px-4 py-4" style="display: none;">
                      <div class="flex items-center space-x-3">
                        <div
                          class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-secondary/10 dark:bg-secondary-light/15">
                          <i class="fa fa-user-edit text-secondary dark:text-secondary-light"></i>
                    ...
                    <div x-show="activeTab === 'tabLogs'" x-transition:enter="transition-all duration-300 easy-in-out"
                      x-transition:enter-start="opacity-0 [transform:translate3d(1rem,0,0)]"
                      x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                      class="is-scrollbar-hidden overflow-y-auto px-4" style="display: none;">
    ...
    <div x-show="$store.breakpoints.isXs &amp;&amp; $store.global.isSearchbarActive"
      ...
      class="fixed inset-0 z-[100] flex flex-col bg-white dark:bg-navy-700 sm:hidden" style="display: none;">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
      ...
      <div class="ads-header-row">
        ...
        <div class="ads-actions">
          ...
          <button class="btn-plus" onclick="document.getElementById('add-cat-modal').style.display='flex'"><i
      ...
      <div class="ads-table-card">
        ...
        <div id="add-cat-modal"
          ...
          <div style="background:white; padding:30px; border-radius:8px; width:400px; max-width:90%;">
            <h3 style="margin-top:0;" id="cat-modal-title">Add New Category</h3>
            ...
            <label style="font-size: 0.9rem; color: #475569; display: block; margin-bottom: 5px;">Category Image</label>
            <input type="file" id="new-cat-image" accept="image/*"
              style="width:100%; padding:10px; margin-bottom:20px; border:1px solid #ccc; border-radius:4px;">

            <div style="display:flex; justify-content:flex-end; gap:10px;">
              <button onclick="document.getElementById('add-cat-modal').style.display='none'"
                style="padding:10px 15px; border:none; border-radius:4px; cursor:pointer;">Cancel</button>
              <button id="cat-save-btn" onclick="saveCategory()"
                style="padding:10px 15px; background:#C8A89A; color:black; border:none; border-radius:4px; cursor:pointer; font-weight:bold;">Save
                Category</button>
            </div>
          </div>
        </div>
        ...
        <div id="add-subcat-modal"
          style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); align-items:center; justify-content:center; z-index:9999;">
          <div style="background:white; padding:30px; border-radius:8px; width:400px; max-width:90%;">
            <h3 style="margin-top:0;" id="subcat-modal-title">Add Subcategory to <span id="subcat-parent-label"></span>
            </h3>
            <input type="hidden" id="old-subcat-name">
            <input type="hidden" id="subcat-parent-name">
            <input type="text" id="new-subcat-name" placeholder="Subcategory Name"
              style="width:100%; padding:10px; margin-bottom:15px; border:1px solid #ccc; border-radius:4px;">

            <label style="font-size: 0.9rem; color: #475569; display: block; margin-bottom: 5px;">Subcategory Image</label>
            <input type="file" id="new-subcat-image" accept="image/*"
              style="width:100%; padding:10px; margin-bottom:20px; border:1px solid #ccc; border-radius:4px;">

            <div style="display:flex; justify-content:flex-end; gap:10px;">
              <button onclick="document.getElementById('add-subcat-modal').style.display='none'"
                style="padding:10px 15px; border:none; border-radius:4px; cursor:pointer;">Cancel</button>
              <button id="subcat-save-btn" onclick="saveSubCategory()"
                style="padding:10px 15px; background:#C8A89A; color:black; border:none; border-radius:4px; cursor:pointer; font-weight:bold;">Save
                Subcategory</button>
            </div>
          </div>
  ...
  <script>
    ...
    function renderCategories() {
      ...
      list.innerHTML = categoriesList.map(c => {
        ...
        const subHtml = subs.map(s => `
                <span style="display:inline-block; background:#f1f5f9; padding:2px 8px; border-radius:12px; font-size:0.8rem; margin:2px;">
                    ${s.name} 
                    <i class="fa fa-pencil" style="cursor:pointer; color:#3498db; margin-left:5px;" onclick="openEditSubCatModal('${c.id}', '${c.name}', '${s.id}', '${s.name}')"></i>
                    <i class="fa fa-times" style="cursor:pointer; color:#e74c3c; margin-left:3px;" onclick="deleteCat('${s.id}')"></i>
                </span>
            `).join('');

        const image = c.image_url;
        const imgHtml = image ? `<img src="${image}" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;">` : `<div style="width: 40px; height: 40px; background: #e2e8f0; border-radius: 4px; display:flex; align-items:center; justify-content:center; color:#94a3b8; font-size:10px;">No Img</div>`;
        ...
        return `
            <tr>
                ...
                <td>
                    <button style="background: #3498db; color: #fff; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer; margin-right: 5px;" onclick="openSubCatModal('${c.id}', '${c.name}')">+ Subcategory</button>
                    <button style="background: #f39c12; color: #fff; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer; margin-right: 5px;" onclick="openEditCatModal('${c.id}', '${c.name}')">Edit</button>
                    <button style="background: #e74c3c; color: #fff; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer;" onclick="deleteCat('${c.id}')">Delete</button>
                </td>
            </tr>
            `;
      }).join('');
    ...
    window.saveCategory = async function () {
      const oldId = document.getElementById('old-cat-name').value; // we use this hidden field for ID now
      ...
      if (oldId) {
        formData.append('_method', 'PUT'); // Laravel interprets this as PUT
      }

      try {
        const url = oldId ? `${API_BASE_URL}/admin/categories/${oldId}` : `${API_BASE_URL}/admin/categories`;
        const method = 'POST'; // Always POST for FormData, Laravel uses _method for PUT
        ...
        if (res.ok) {
          document.getElementById('old-cat-name').value = '';
    ...
    window.openSubCatModal = function (catId, catName) {
      document.getElementById('subcat-modal-title').innerHTML = `Add Subcategory to <span id="subcat-parent-label">${catName}</span>`;
      document.getElementById('subcat-save-btn').innerText = 'Save Subcategory';
      document.getElementById('subcat-parent-name').value = catId; // Hidden field used for parent ID
      document.getElementById('old-subcat-name').value = '';
      document.getElementById('new-subcat-name').value = '';
      document.getElementById('new-subcat-image').value = '';
      document.getElementById('add-subcat-modal').style.display = 'flex';
    }

    window.openEditSubCatModal = function (parentId, parentName, subId, subName) {
      document.getElementById('subcat-modal-title').innerHTML = `Edit Subcategory <span id="subcat-parent-label"></span>`;
      document.getElementById('subcat-save-btn').innerText = 'Update Subcategory';
      document.getElementById('subcat-parent-name').value = parentId;
      document.getElementById('old-subcat-name').value = subId; // Hidden field used for subcat ID
      document.getElementById('new-subcat-name').value = subName;
      document.getElementById('new-subcat-image').value = '';
      document.getElementById('add-subcat-modal').style.display = 'flex';
    }

    window.openEditCatModal = function (catId, catName) {
      ...
      document.getElementById('old-cat-name').value = catId; // Using this field for ID
    ...
    window.saveSubCategory = async function () {
      const parentId = document.getElementById('subcat-parent-name').value;
      const subId = document.getElementById('old-subcat-name').value; // Using for ID
      const subName = document.getElementById('new-subcat-name').value.trim();
      const fileInput = document.getElementById('new-subcat-image');

      if (parentId && subName) {
        try {
          const url = subId ? `${API_BASE_URL}/admin/categories/${subId}` : `${API_BASE_URL}/admin/categories`;

          // Use FormData so we can attach an image file if provided
          ...
          if (res.ok) {
            document.getElementById('add-subcat-modal').style.display = 'none';
            fetchCategories();
          } else {
            const err = await res.json();
            alert('Error saving subcategory: ' + JSON.stringify(err));
          }
        } catch (e) { console.error('Subcat save error', e); }
      }
    }
