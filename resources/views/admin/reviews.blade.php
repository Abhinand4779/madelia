...
<i class="text-xl fas fa-tags"></i>    
                    ...
                    <a href="/admin/reviews" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Reviews'">
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
      ...
      <div class="mt-1 font-inter font-medium">
        ...
        <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100" href="dashboards-influencer.html">
          ...
          <div wire:id="bPSpbX0mpbljpllKJHx4">
...
<!-- Livewire Component wire-end:bPSpbX0mpbljpllKJHx4 -->
          </main>
        </div>
        <!-- 
