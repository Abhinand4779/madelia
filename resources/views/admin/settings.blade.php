...
<body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
  ...
  <div id="root" class="flex min-h-100vh grow bg-slate-50 dark:bg-navy-900">
                  ...
                  <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content"
                    ...
                    <div class="simplebar-content" style="padding: 0px 0px 24px;">
                      <ul class="flex flex-col flex-1 px-4 font-inter">
                        ...
                        <li>
                          <a href="/admin/main-titles"
                            class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                            Main titles / Videos
                          </a>
                        </li>
                        <li>
                          <a href="/admin/dynamic-products"
                            class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                            Dynamic Products
                          </a>
                        </li>
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
      ...
      <div class="ads-header-row" style="display: flex; justify-content: space-between; align-items: center;">
        <h2>Storefront Settings</h2>
        <button type="submit" form="settings-form" class="btn-apply" style="font-size: 1rem; padding: 0.6rem 2rem;">Save
          Changes</button>
      </div>

      <div class="ads-table-card" style="padding: 2rem; padding-bottom: 10rem;">
        <form id="settings-form" onsubmit="saveSettings(event)">
          <h3 class="form-label"
            style="font-size: 1.1rem; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem; margin-bottom: 1.5rem;">
            Navbar Settings</h3>
          <div class="form-group" style="margin-bottom: 1rem;">
            <label class="form-label">Promo Banner Text (Leave blank to hide)</label>
            <input type="text" id="promo-banner" class="form-control" style="width: 100%;"
              placeholder="e.g. FREE SHIPPING on orders above 899 | COD Available">
          </div>

          <h3 class="form-label"
            style="font-size: 1.1rem; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem; margin-bottom: 1.5rem; margin-top: 3rem;">
            Hero Section</h3>
          <div class="form-group" style="margin-bottom: 1rem;">
            <label class="form-label">Hero Tagline (Golden Text)</label>
            <input type="text" id="hero-subtitle" class="form-control" style="width: 100%;" required>
          </div>
          <div class="form-group" style="margin-bottom: 1rem;">
            <label class="form-label">Hero Tagline (White Text)</label>
            <input type="text" id="hero-title" class="form-control" style="width: 100%;" required>
          </div>
          <div class="form-group" style="margin-bottom: 1rem; display: none;">
            <label class="form-label">Hero Description</label>
            <textarea id="hero-desc" class="form-control" style="width: 100%;" rows="3"></textarea>
          </div>

          <h3 class="form-label"
            style="font-size: 1.1rem; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem; margin-bottom: 1.5rem; margin-top: 3rem;">
            Main Navigation Links</h3>
          <div id="nav-links-container" style="display: flex; flex-direction: column; gap: 1rem;">
          </div>
          <button type="button" class="btn-plus" onclick="addNavLink()"
            style="font-size: 0.9rem; border: 1px dashed #cbd5e1; padding: 0.8rem; border-radius: 4px; width: 100%; margin-top: 1rem; background: #f8fafc;"><i
              class="fa fa-plus" style="margin-right: 0.5rem;"></i> Add New Link</button>

          <h3 class="form-label"
            style="font-size: 1.1rem; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem; margin-bottom: 1.5rem; margin-top: 3rem;">
            Navbar Categories</h3>
          <p style="font-size: 0.9rem; color: #64748b; margin-bottom: 1rem;">Select the categories you want to display
            in the top navigation bar. If you select none, the top 5 active categories will be shown automatically.</p>
          <div id="navbar-categories-container" style="display: flex; flex-wrap: wrap; gap: 1rem; margin-bottom: 2rem;">
            <div style="font-size: 0.9rem; color: #94a3b8;"><i class="fa fa-spinner fa-spin"></i> Loading categories...
            </div>
          </div>

          <div class="modal-footer-custom" style="margin-top: 2rem; border-top: 1px solid #e2e8f0;">
            <button type="submit" class="btn-apply" style="font-size: 1.1rem; padding: 0.8rem 3rem;">Save
              Changes</button>
          </div>
        </form>
      </div>
      <script src="/admin/js/admin-settings-v2.js"></script>
